...
@InputType()
class LoyaltyProgramUpdateManyWithoutRestaurantManagementsInput {
...
export { LoyaltyProgramUpdateManyWithoutRestaurantManagementsInput as LoyaltyProgramUpdateManyWithoutRestaurantManagementsInput };
