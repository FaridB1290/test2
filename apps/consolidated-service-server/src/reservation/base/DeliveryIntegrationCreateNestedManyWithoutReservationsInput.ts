...
@InputType()
class DeliveryIntegrationCreateNestedManyWithoutReservationsInput {
...
export { DeliveryIntegrationCreateNestedManyWithoutReservationsInput as DeliveryIntegrationCreateNestedManyWithoutReservationsInput };
