...
export class NotificationResolverBase {
  ...
  async createNotification(
    ...
    return await this.service.createNotification({
      ...
      data: {
        ...
        customerFeedback: args.data.customerFeedback
          ? {
              connect: args.data.customerFeedback,
            }
          : undefined,
      },
    });
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => CustomerFeedback, {
    nullable: true,
  ...
  async getCustomerFeedback(
    ...
    const result = await this.service.getCustomerFeedback(parent.id);
