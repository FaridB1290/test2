...
@InputType()
class ReservationCreateNestedManyWithoutInventoriesInput {
...
export { ReservationCreateNestedManyWithoutInventoriesInput as ReservationCreateNestedManyWithoutInventoriesInput };
